...
const Documentation = () => {
  return (
    <div className="min-h-screen w-full bg-space-gradient bg-fixed">
      <div className="container py-8 mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold tracking-tight mb-2 text-white">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-space-cosmic-teal to-space-nebula-pink">
              LayerZero Documentation
            </span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl">
            Comprehensive guide to the LayerZero V2 protocol and cross-chain communications
          </p>
        </motion.div>
